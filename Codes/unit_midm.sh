...
#SBATCH -J sa_midm     # job name
#SBATCH --output=midm_job_output.log    # Output log file - change name
#SBATCH --error=midmjob_error.log      # Error log file - change name
