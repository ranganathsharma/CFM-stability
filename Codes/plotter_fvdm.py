...
model = "fvdm"  # Change this to the actual model name
...
#         density_perturbation_space(data = data, instability = 'convective_numerical', sens_relvel = sens_relvel, sens_vel = sens_vel)
...
def phase_plot(data: pd.DataFrame,
    ...
    if density == 70:
        ...
        coordinates = [(3, 10), (4, 8), (5, 6), (6, 4), (7, 2), (2, 4), (3, 2)]
    ...
    if density == 42:
        ...
        # Differece between small and large perturbation

        coordinates = [(1, 1), (1, 2), (1,3), (2,2), (1,4), (1,5), (2, 3)]
        ax = patching(ax, coordinates, 'b')
...
# phase_plot(data= data, instability = 'convective_analytical', density =  70, da = 0.1, dtau = 1, model = 'fvdm')
# phase_plot(data= data, instability = 'convective_numerical', density =  70, da = 0.1, dtau = 1, model = 'fvdm')
...
def parameter_perturbation(data: pd.DataFrame, density: float, instability: str):
    ...
    fig, axes = plt.subplots(3, 3, figsize=(6, 6), dpi=600, sharex=True, sharey=True)
...
# parameter_perturbation(data = data, density = 54, instability = 'convective_numerical')
...
def stability_class(model, quantity):
    ...
    for i in range(len(data)):
        ...
        elif data.iloc[i][column_name] in ['snaus', 'saus']:
...
# stability_class('fvdm', 'numerical')
# stability_class('fvdm', 'analytical')